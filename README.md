...
<ul>
  <li>The directory of the files can mess with using jest, the solution was to make a simple directory with a simple name. (Maybe the folder called, '.git' messed with locating the files because it uses a . first)</li>
...
<ul>
  ...
  <li>Youtube odin project questions when stuck to learn easier and save time, 
    <br>(https://www.youtube.com/watch?v=Qru6rRxEzlY&ab_channel=CodewithSajid) This video was really helpful and had other tips</li>
</ul>
